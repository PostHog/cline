...
export const BrowserSettingsOptions: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <div style={{ marginBottom: 0 }}>
                <div
                    style={{ marginBottom: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}
                >
                    <VSCodeCheckbox
                ...
                >
                    Enable PostHog to use your Chrome
                    {isBundled
...
export default BrowserSettingsOptions
